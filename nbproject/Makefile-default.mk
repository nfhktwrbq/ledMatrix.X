...
${OBJECTDIR}/src/menu/Menu.o: src/menu/Menu.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/menu/Menu.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega328p ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS} -g -DDEBUG  -gdwarf-2  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000UL -DATMEGA328  -I "include" -I "include/display" -I "include/interfaces" -I "include/menu" -I "include/sensors" -I "include/utils" -I "include/memory" -Wall -MD -MP -MF "${OBJECTDIR}/src/menu/Menu.o.d" -MT "${OBJECTDIR}/src/menu/Menu.o.d" -MT ${OBJECTDIR}/src/menu/Menu.o  -o ${OBJECTDIR}/src/menu/Menu.o src/menu/Menu.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 
...
${OBJECTDIR}/src/menu/Menu.o: src/menu/Menu.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/src/menu/Menu.o.d 
	@${RM} ${OBJECTDIR}/src/menu/Menu.o 
	 ${MP_CC}  $(MP_EXTRA_CC_PRE) -mmcu=atmega328p ${PACK_COMPILER_OPTIONS} ${PACK_COMMON_OPTIONS}  -x c -c -D__$(MP_PROCESSOR_OPTION)__  -funsigned-char -funsigned-bitfields -O3 -ffunction-sections -fdata-sections -fpack-struct -fshort-enums -DF_CPU=16000000UL -DATMEGA328  -I "include" -I "include/display" -I "include/interfaces" -I "include/menu" -I "include/sensors" -I "include/utils" -I "include/memory" -Wall -MD -MP -MF "${OBJECTDIR}/src/menu/Menu.o.d" -MT "${OBJECTDIR}/src/menu/Menu.o.d" -MT ${OBJECTDIR}/src/menu/Menu.o  -o ${OBJECTDIR}/src/menu/Menu.o src/menu/Menu.c  -DXPRJ_default=$(CND_CONF)  $(COMPARISON_BUILD) 

...
MAKE_MENU(Level1ItemSensorsShowTimeout  , Level1ItemSensorsSelect	  , Level1ItemEnterTime	   , 	  NULL_ENTRY ,				NULL_ENTRY     , menu_enterSensorsTimeout   , NULL_FUNC           , 2);
...
MAKE_MENU(Level2ItemTemperature    		, Level2ItemHumidity		  , Level2ItemCO2,				  Level1ItemSensorsSelect , NULL_ENTRY     , NULL_FUNC           		, NULL_FUNC           , 3);
MAKE_MENU(Level2ItemHumidity    		, Level2ItemPressure		  , Level2ItemTemperature, 		  Level1ItemSensorsSelect , NULL_ENTRY     , NULL_FUNC           		, NULL_FUNC           , 3);
MAKE_MENU(Level2ItemPressure    		, Level2ItemCO2				  , Level2ItemHumidity,			  Level1ItemSensorsSelect , NULL_ENTRY     , NULL_FUNC           		, NULL_FUNC           , 3);
MAKE_MENU(Level2ItemCO2		    		, Level2ItemTemperature		  , Level2ItemPressure, 		  Level1ItemSensorsSelect , NULL_ENTRY     , NULL_FUNC           		, NULL_FUNC           , 3);
